...
public interface INames {
	...
	public static String NETHERRACKFURNACE 			= "netherrack_furnace";
	public static String BARREL						= "barrel";
	public static String FREEZER 					= "freezer";
	public static String CRUCIBLE					= "crucible";
	
	public static String DOORNTMSTONE				= "door_ntm_stone";
	public static String DOORNTMELDER				= "door_ntm_elder";
	public static String DUST 						= "dust";
	public static String STWH 						= "stairway_to_heaven";
	public static String ELDERSAPLING 				= "elder_sapling";
	public static String ELDERLEAVES 				= "elder_leaves";
	public static String ELDERPLANKS				= "elder_planks";
	public static String ELDERSLAB					= "elder_slab";
	public static String ELDERSLABHALF				= "elder_slab_half";
	public static String ELDERLOG 					= "elder_log";
	public static String NETHERRACKGRAVEL			= "netherrack_gravel";
