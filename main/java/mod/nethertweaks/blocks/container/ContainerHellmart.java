...
public class ContainerHellmart extends ContainerBase {
	
	private TileHellmart tileEntity;
	
	public ContainerHellmart(InventoryPlayer inventoryPlayer, TileHellmart te) {
		super(te);
		tileEntity = te;
