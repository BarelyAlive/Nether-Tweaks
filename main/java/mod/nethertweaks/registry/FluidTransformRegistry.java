...
import mod.nethertweaks.registry.manager.IFluidTransformDefaultRegistryProvider;
...
public class FluidTransformRegistry
{
    ...
    private static void registerInternal(FluidTransformer transformer)
    {
        ...
        registryInternal.put(transformer.getInputFluid().toString(), list);
    }
    ...
    {
		for (IFluidTransformDefaultRegistryProvider provider : NTMRegistryManager.getDefaultFluidTransformRecipeHandlers()) {
