...
import mod.nethertweaks.registry.manager.ICompostDefaultRegistryProvider;
...
public class CompostRegistry {
	...
	{
		for (ICompostDefaultRegistryProvider provider : NTMRegistryManager.getDefaultCompostRecipeHandlers()) {
	...
	public static void recommendAllFood(File file)
	{
	    ...
	    for(Item item : Item.REGISTRY)
	    {
	        if(item instanceof ItemFood)
	        {
	            ...
	            food.getSubItems(NetherTweaksMod.tabNTM, stacks);
