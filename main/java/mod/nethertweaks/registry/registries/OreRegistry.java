...
import mod.nethertweaks.registry.registries.base.types.EnumOreSubtype;
...
public class OreRegistry extends BaseRegistryList<Ore> implements IOreRegistry {
	 ...
	 */
	public Ore register(final String name, final Color color, final ItemInfo info) {
	...
	@Override
	@Nonnull
	public Ore register(@Nonnull final String name, @Nonnull final Color color, final ItemInfo info, final Map<String, String> translations, final String oredictName) {
	...
	@Override
	public void register(final Ore value) {
		registry.add(value);
	...
	public void registerToGameRegistry(final IForgeRegistry<Item> itemRegistry) {
	...
	@Override
	public ItemOre getOreItem(@Nonnull final String name) {
		for (ItemOre itemOre : itemOreRegistry)
