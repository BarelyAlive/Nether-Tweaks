...
public class RecipeHandler {
	...
	public static void loadRecipes(){
		...
		if(Config.endTeleport){
			...
			GameRegistry.addShapedRecipe(new ItemStack(NTMBlocks.endteleport), "XXX", "XYX", "XXX", x, Konstanten.ENDBOX, y, Konstanten.PORTALCORE);
		...
		GameRegistry.addShapedRecipe(Konstanten.SIEVEWEB, "XXX", "XXX", "XXX", x, NTMBlocks.meanVine);
		...
		GameRegistry.addShapedRecipe(new ItemStack(NTMBlocks.blockFreezer), "XYZ", x, Items.REDSTONE, y, NTMBlocks.blockCondenser, z, 
				UniversalBucket.getFilledBucket(ForgeModContainer.getInstance().universalBucket, NTMItems.fluidDemonWater));
		GameRegistry.addShapedRecipe(new ItemStack(NTMBlocks.blockFreezer), "XYZ", x, Items.REDSTONE, y, NTMBlocks.blockCondenser, z, NTMItems.bucketStoneDemonWater);
		GameRegistry.addShapedRecipe(new ItemStack(NTMBlocks.blockFreezer), "XYZ", x, Items.REDSTONE, y, NTMBlocks.blockCondenser, z, NTMItems.bucketWoodDemonWater);
	...
	public static void oreRegistration()
    {
		...
		OreDictionary.registerOre("vine", NTMBlocks.meanVine);
    ...
    public static void addOreRecipes()
    {
    	...
    	GameRegistry.addRecipe(new ShapedOreRecipe(NTMItems.bucketStone, "X X", " X ", x, "cobblestone"));
    	GameRegistry.addRecipe(new ShapedOreRecipe(NTMItems.bucketWood, "X X", " Y ", x, "plankWood", y, "slabWood"));
